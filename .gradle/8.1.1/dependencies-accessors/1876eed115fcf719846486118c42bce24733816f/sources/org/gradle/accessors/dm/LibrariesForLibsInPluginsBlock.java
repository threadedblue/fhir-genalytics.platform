...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class Slf4jLibraryAccessors extends SubDependencyFactory {
        private final Slf4jLibraryAccessors$1 laccForSlf4jLibraryAccessors$1 = new Slf4jLibraryAccessors$1(owner);
         ...
         */
        @Deprecated
        public Slf4jLibraryAccessors$1 get() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSlf4jLibraryAccessors$1;
        }
     ...
     */
    @Deprecated
    public static class Slf4jLibraryAccessors$1 extends SubDependencyFactory {

        public Slf4jLibraryAccessors$1(AbstractExternalDependencyFactory owner) { super(owner); }
