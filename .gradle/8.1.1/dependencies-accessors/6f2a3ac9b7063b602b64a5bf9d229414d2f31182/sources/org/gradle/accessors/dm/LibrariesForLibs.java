...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SprinLibraryAccessors laccForSprinLibraryAccessors = new SprinLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at sprin
     */
    public SprinLibraryAccessors getSprin() {
        return laccForSprinLibraryAccessors;
    }
    ...
    public static class SprinLibraryAccessors extends SubDependencyFactory {

        public SprinLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
