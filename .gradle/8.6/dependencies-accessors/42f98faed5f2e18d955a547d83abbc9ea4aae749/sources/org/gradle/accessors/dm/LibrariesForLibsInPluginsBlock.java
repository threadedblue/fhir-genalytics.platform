...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>fhirEmf</b> with <b>org.hl7.fhir:fhir.emf</b> coordinates and
    ...
    /**
     * Dependency provider for <b>jacksonAnnotations</b> with <b>com.fasterxml.jackson.core:jackson-annotations</b> coordinates and
    ...
    /**
     * Dependency provider for <b>jacksonCore</b> with <b>com.fasterxml.jackson.core:jackson-core</b> coordinates and
     * with version reference <b>jackson</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
    ...
    /**
     * Dependency provider for <b>mwe2Launch</b> with <b>org.eclipse.emf:org.eclipse.emf.mwe2.launch</b> coordinates and
     * with version reference <b>mwe2</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>queryDSL</b> with <b>org.hl7.fhir:d4m.acc.query</b> coordinates and
     * with version reference <b>query</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     ...
     * with version reference <b>redis</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>springActuator</b> with <b>org.springframework.boot:spring-boot-starter-actuator</b> coordinates and
    ...
    /**
     * Dependency provider for <b>springSessionDataRedis</b> with <b>org.springframework.session:spring-session-data-redis</b> coordinates and
     * with version reference <b>springboot</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
    ...
    /**
     * Dependency provider for <b>springStarterDataRedis</b> with <b>org.springframework.session:spring-starter-data-redis</b> coordinates and
     * with version reference <b>springboot</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
    ...
    /**
     * Dependency provider for <b>springTest</b> with <b>org.springframework.boot:spring-boot-starter-test</b> coordinates and
     * with version reference <b>springboot</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
    ...
    /**
     * Dependency provider for <b>springWeb</b> with <b>org.springframework.boot:spring-boot-starter-web</b> coordinates and
     * with version reference <b>springboot</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
    ...
    /**
     * Dependency provider for <b>xtext</b> with <b>org.eclipse.xtext:org.eclipse.xtext</b> coordinates and
     * with version reference <b>xtext</b>
     * <p>
     * This dependency was declared in catalog libraries.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>fhir</b> with value <b>4.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>guava</b> with value <b>33.4.8-jre</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mwe2</b> with value <b>2.22.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>query</b> with value <b>0.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>redis</b> with value <b>3.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>xcore</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>xtext</b> with value <b>2.39.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
